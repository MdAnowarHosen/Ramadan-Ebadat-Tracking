            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <g class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:translate-y-4 starting:opacity-0">
                            <path
                        ...
                        <g
                            ...
                            class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:translate-y-4 starting:opacity-0"
                        >
                            <path
